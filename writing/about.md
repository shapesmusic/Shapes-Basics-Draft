...
So many of the most fundamental ideas that run throughout Shapes are present in this first lesson:

- the focus isn't on what to play, but what's possible to play. 
- it's drawing on intuitions you already have. wrong notes, and having a sense of what to play next.
- creates a concept that's an environment to explore within.





you could continue, but a tour departs from just starting because it's an overview. so here's a map!
...
of a method, perhaps, and of a method embedded in software. 
